...
if (file_exists($rootPath . $versionFile)) {
    ...
    $fileContents = preg_replace("#DEV_LEVEL\s*=\s*'[^\']*'#", "DEV_LEVEL = '" . $version['dev_level'] . "'", $fileContents);
    ...
    $fileContents = preg_replace("#RELEASE_DATE\s*=\s*'[^\']*'#", "RELEASE_DATE = '" . $version['release_date'] . "'", $fileContents);
    $fileContents = preg_replace("#RELEASE_TIME\s*=\s*'[^\']*'#", "RELEASE_TIME = '" . $version['release_time'] . "'", $fileContents);
    $fileContents = preg_replace("#RELEASE_TIMEZONE\s*=\s*'[^\']*'#", "RELEASE_TIMEZONE = '" . $version['release_timezone'] . "'", $fileContents);
